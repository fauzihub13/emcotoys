        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">A page where you can manage product categories</p>
                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2 justify-content-center">
                                                    <a href="{{ route('product.category.edit', $category) }}" class="btn icon btn-primary">
...
@push('script')
    ...
    <script src="{{ asset ('assets/admin/custom/js/list-product-category.js') }}"></script>
@endpush
