        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">A page where you can manage article categories</p>
                </div>
        ...
        <section class="section">
            <div class="card">
                <div class="card-header ">
                    <a href="{{ route('article.category.create') }}" class="btn btn-primary">Add</a>
                </div>
                <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2 justify-content-center">
                                                    <a href="{{ route('article.category.edit', $category) }}" class="btn icon btn-primary">
                                                    ...
                                                    <form id="delete-article-category-form" action="" method="POST" style="display: none;">
...
@push('script')
    ...
    <script src="{{ asset ('assets/admin/custom/js/list-article-category.js') }}"></script>
@endpush
