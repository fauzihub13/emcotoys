        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Marketplaces</h3>
                    <p class="text-subtitle text-muted">A page where you can manage marketplace</p>
                </div>
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Markeplace</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <section class="section">
            <div class="card">
                <div class="card-header ">
                    <a href="{{ route('marketplace.create') }}" class="btn btn-primary">Add</a>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table" id="table1">
                            ...
                            <tbody>
                                ...
                                @if (isset($marketplaces) && $marketplaces != [])
                                    @foreach ($marketplaces as $marketplace)
                                        <tr>
                                            <td>{{ $loop->index + 1 }}</td>
                                            <td>
                                                <div class="avatar avatar-md">
                                                    <img src="{{ asset ('storage/'.$marketplace->image)}}">
                                                </div>
                                            </td>
                                            <td>{{ $marketplace->name }}</td>
                                            <td>
                                                <div class="d-flex gap-2 justify-content-center">
                                                    <a href="{{ route('marketplace.edit', $marketplace) }}" class="btn icon btn-primary">
                                                    ...
                                                    <form id="delete-marketplace-form" action="" method="POST" style="display: none;">
...
@push('script')
    ...
    <script src="{{ asset ('assets/admin/custom/js/list-marketplace.js') }}"></script>
@endpush
